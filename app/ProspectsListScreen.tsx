...
const handleSelect = (id: string) => {
  const selectedCount = prospects.filter(t => t.isStarred).length;

  setProspects(prev =>
    prev.map(ticket => {
      if (ticket.id === id) {
        if (!ticket.isStarred && selectedCount >= 10) {
          alert("Solo puedes seleccionar hasta 10 tickets");
          return ticket;
        }
        return { ...ticket, select: !ticket.isStarred }; // Toggle correcto
      }
      return ticket;
    })
  );
                ...
                <>
                  ...
                  <TouchableOpacity
                    ...
                    style={{
                      ...
                      borderColor: "#000",
                      marginRight: 10,
                      backgroundColor: item.isStarred ? "green" : "white",
                    }}
                  />
